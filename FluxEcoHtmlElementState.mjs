...
export class FluxEcoHtmlElementState {
    /**
     * @typedef {object} FluxEcoHtmlElementData
     * @property {string} name
     * @property {string} tagName
     * @property {object} styleValues
     * @property {string} innerText
     * @property {Object<string>} attributeValues
     * @property {array<string>} childElementsName
     */
    ...
    /**
     * @param {FluxEcoHtmlElementSpecData} specification
     * @param {array} transitionFlow
     * @return {FluxEcoHtmlElementStateValues}
     */
    createBySpecification(specification, transitionFlow = [
        ...
        const {tag, name, attributeValues, childElementsName} = specification;
